...
const pillars = [
  {
    num: "/ 01",
    title: "Episodes.",
    body: "The flotilla. Eight Saturdays per SEAson on Biscayne Bay — twelve seats per Episode, choreographed dock to dock, one designed day at a time. The proof point. The reason the Crew started showing up.",
    href: "/episodes",
    cta: "See SEAson 1",
  },
  {
    num: "/ 02",
    title: "The Network.",
    body: "Seven verticals — Entertainment, Sports, Health and Wellness, Hospitality, Travel, Retail, Nightlife. Anchor partners in each. Captain priority across the network; Commodore on the curated tier — paddock, preview day, off-market suite, capsule pre-allocation.",
    href: "/network",
  ...
  },
  {
    num: "/ 03",
    title: "The Harbor.",
    body: "The operating system. Concierge, The Mark, the Log, the Crew Directory, the Mark Wallet. Where membership lives between Saturdays. Captain members get full access; Crew get read-only. Opening SEAson 2.",
    href: "/membership",
